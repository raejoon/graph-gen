...
python $ROOT_DIR/graph-generate/main.py --binomial --prob 0.5 --num 100 \
    --max-seed 100 --outdir $GRAPH_DIR
echo "Generated binomial graphs."

seq 0 9 > $SEED_FILE
echo "Generated seed file."

for ALGO in solo solo2 sleepwell desync;
do
    ALGO_DIR=./logs/$ALGO
    mkdir -p $ALGO_DIR
